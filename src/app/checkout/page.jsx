...
function SuccessCard({ codigo }) {
    return (
        <div className="mt-3 rounded-md border border-emerald-500/40 bg-emerald-500/10 p-4 text-emerald-200">
            <p className="text-sm">Código de check-out gerado:</p>
...
export default function CheckIn({ className, searchParams, ...props }) {
    ...
    async function handleSubmit(event) {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${API_BASE}/api/codigo/liberar-checkout`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                credentials: "include",
            ...
            setErrors((prev) => ({ ...prev, geral: "Falha ao liberar check-out. Tente novamente." }));
        } finally {
            setIsLoading(false);
        }
    }
    ...
    return (
        ...
        >
            ...
            {/* Card */}
            <div className="rounded-lg mx-4 p-4 bg-slate-700 ">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        <div className="relative flex items-end gap-2">
                            <div className="flex w-full flex-col gap-2">
                                <label htmlFor="turma" className="text-sm text-white">Turma</label>
                                <input
                                    id="turma"
                                    type="text"
                        ...
                        <div className="mt-4 flex flex-col gap-3">
                            ...
                            >
                                {isLoading ? "Liberando..." : "Liberar Check-Out"}
                            </button>
